...
function Data() {
    return (
        <Container>
            ...
            <div className="module" id="campaign-stream">
                <div className="row stream-module-container">
                    <div className="large-12 columns">
                        <div className="campaign-stream-module module">
                            <div className="section-header stream"><h2 className="name"><span className="section-header-icon op-icon-forum"></span>Stream</h2></div>
                            ...
                            <ul className="recent-updates divided-list">
                                ...
                                <div className="time">
                                <time className="timeago-reformat" dateTime="2023-06-01T13:44:32Z">13 days ago</time>
                                </div>
                                </div>
