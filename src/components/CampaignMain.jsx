function CampaignMain({ children }) {
    return (
        <div>
            { children }
        </div>
    ...
    /*
    return (
        <div class="columns main-content-container dynamic-sheet-width">
            <main class="main-content">
                <div class="highlight-container"></div>
                    <div class="campaign-landing-page-container" itemscope="" itemtype="http://schema.org/CreativeWork">
                        <div class="wiki-page section" itemprop="description">
                            ...
                            <p>
                                <a href="/characters/hermann-m-ller" class="wiki-content-link">Hermann Müller</a>
                                <br />
                                <a href="/characters/frank-patterson" class="wiki-content-link">Frank Patterson</a>
                            </p>
                            <p>
                            ...
                            <p>
                                <a href="/characters/colonel-williams" class="wiki-content-link">Colonel John Williams</a><br />
                                <a href="/characters/lord-fyrom-squibb" class="wiki-content-link">Lord Fyrom Squibb</a>
                            </p>
                            ...
                            <p><a href="/characters/john-yip" class="wiki-content-link">John Yip</a></p>
                            ...
                            <p>
                                <a href="/characters/boris-vasilijev" class="wiki-content-link">Boris Vasilijev</a>
                                <br />
                                <a href="/characters/edvard-natt-och-dag" class="wiki-content-link">Edvard Natt och Dag</a>
                            </p>
                            ...
                            <p><a href="/characters/dr-errol-murray" class="wiki-content-link">Dr. Errol Murray</a></p>
                            ...
                            <p>
                                <a href="/characters/ian-flannery" class="wiki-content-link">Ian Flannery</a>
                                <br />
                                <a href="/characters/professor-walter-scott-jr" class="wiki-content-link">Professor Walter Scott JR</a>
                            </p>
                            ...
                            <p><a href="/characters/manfred-schultz" class="wiki-content-link">Manfred Schultz</a></p>
                            ...
                            <p><a href="/characters/max-von-moser" class="wiki-content-link">Max von Moser</a></p>
                    ...
                    <div class="microdata hide">
                        ...
                        <img alt="Hotoe" class="hide" itemprop="image" src="https://db4sgowjqfwig.cloudfront.net/campaigns/113476/banners/513354/HotOE.jpg?1443986861" />
